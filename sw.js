const CACHE_NAME = 'pesotrack-1-0-gold-master-v55';
...
self.addEventListener('fetch', event => {
  ...
  const wantsFreshShell = event.request.mode === 'navigate' || event.request.url.endsWith('/index.html') || event.request.url.endsWith('/');
  if (wantsFreshShell) {
