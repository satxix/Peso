...
function recurringMonthTotal(items){return (items||[]).filter(r=>r&&typeof r==='object'&&r.enabled!==false).reduce((sum,r)=>sum+Math.abs(Number(r.amount||0)),0)}
